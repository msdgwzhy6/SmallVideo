...
public class CaptureLayout extends FrameLayout {
    ...
    private AlbumLisenter albumLisenter;        //相册按钮监听
    ...
    public void setAlbumLisenter(AlbumLisenter albumLisenter) {
        this.albumLisenter = albumLisenter;
    }
...
//                resetCaptureLayout();
        ...
        iv_album = new ImageView(getContext());
        LayoutParams iv_album_param = new LayoutParams((int) (button_size / 2.5f), (int) (button_size / 2.5f));
        iv_album_param.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        iv_album_param.setMargins(0, 0, layout_width / 6, 0);
        iv_album.setLayoutParams(iv_album_param);
        iv_album.setImageResource(R.drawable.ic_album);
        showAlbumButton(false);
        iv_album.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (albumLisenter != null) {
                    albumLisenter.openAlbum();
                }
            }
        });
     ...
     */
    public void showAlbumButton(boolean visibility) {
        iv_album.setVisibility(visibility ? VISIBLE : GONE);
        isShowAlbumButton = visibility;
    }
    ...
    public void resetCaptureLayout() {
        ...
        showAlbumButton(isShowAlbumButton);
    }
